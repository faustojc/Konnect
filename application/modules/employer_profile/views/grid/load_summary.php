<?php if (empty($current_employer->summary)) : ?>
    <div class="d-flex flex-column flex-grow-1 border rounded p-3">
        ...
        <div class="d-flex flex-column flex-grow-1">
            ...
            <button type="button" class="btn btn-outline-secondary rounded-pill bg-gray-light edit-summary" style="border-width: 2px" data-toggle="modal" data-target="#summary-modal">Add a summary</button>
        </div>
    </div>
<?php else : ?>
