...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a class="nav-link" href="#" role="button"> <i class="fas fa-th-large">test</i> </a>
            </li>
        </ul>
    </nav>
    <!-- /.navbar -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index3.html" class="brand-link">
            <img src="<?= base_url() ?>assets/images/Logo/logo.jpg" alt="AdminLTE Logo"
                 class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light"><?= SYSTEM_MODULE ?></span> </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <!-- <div class="info">
                        <a href="<?= base_url() ?>obo_login" class="d-block">LOGOUT BUTTON HERE</a>
                    </div> -->
            </div>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url() ?>employer"
                                   class="nav-link <?= (sidebar($menubar, ['employer'])) ? 'active' : '' ?>">
                                    <!-- Sean - 05.08.23 -->
                                    <i class="fas fa-user nav-icon"></i>
                                    <p>Employer</p>
                                    <!-- END  -->
                                </a> <a href="<?= base_url() ?>employee"
                                        class="nav-link <?= (sidebar($menubar, ['employee'])) ? 'active' : '' ?>">
                                    <!-- Sean - 05.08.23 -->
                                    <i class="fas fa-user nav-icon"></i>
                                    <p>Employee</p>
                                    <!-- END  -->
                                </a> <a href="<?= base_url() ?>employee_educ"
                                        class="nav-link <?= (sidebar($menubar, ['education'])) ? 'active' : '' ?>">
                                    <!-- Sean - 05.08.23 -->
                                    <i class="fas fa-user nav-icon"></i>
                                    <p>Education</p>
                                    <!-- END  -->
                                </a> <a href="<?= base_url() ?>employment"
                                        class="nav-link <?= (sidebar($menubar, ['employment'])) ? 'active' : '' ?>">
                                    <!-- Sean - 05.08.23 -->
                                    <i class="fas fa-user nav-icon"></i>
                                    <p>Employment</p>
                                    <!-- END  -->
                                </a> <a href="<?= base_url() ?>jobposting"
                                        class="nav-link <?= (sidebar($menubar, ['jobposting'])) ? 'active' : '' ?>">
                                    <!-- Sean - 05.08.23 -->
                                    <i class="fas fa-user nav-icon"></i>
                                    <p>Job Posting</p>
                                    <!-- END  -->
...
<script src="<?= base_url() ?>assets/theme/adminlte/AdminLTE/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js">
</script>
<script
