        ...
        <?php if (!empty($applicants)):
            ...
            if ($applicant->status != 'ACCEPTED' && $applicant->status != 'REJECTED') {
                ...
                <div class="col-12 col-md-6">
                    <a href="employee_profile\index\<?= $applicant->employee_id ?>" style="color:#000;">
                        <div class="row pl-3 pt-2">
                            <div class="col-4 col-md-3">

                                <div class="widget-user-image">
                                    <img class="img-circle img-fluid" src="<?= base_url() ?>assets/images/employee/profile_pic/<?= $applicant->employeeImage ?>" alt="<?= $applicant->employeeName ?>"
                                         style="object-fit: cover;min-width: 50px; max-width: 50px; min-height: 50px; max-height: 50px;">
                                </div>
                            </div>
