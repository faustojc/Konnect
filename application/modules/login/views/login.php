...
<body class="fade-in">
    <div class="container mx-auto h-100 d-flex align-items-center">
        <div class="card mx-auto my-2 my-md-5" style="border-radius: 15px; width:45rem;">
            <div class="row align-items-center flex-column p-3">
