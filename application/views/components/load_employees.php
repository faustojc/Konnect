...
if (!empty($employees)) {
    foreach ($employees as $index => $employee) {
        ?>
        <a href="<?php echo base_url() ?>employee_profile?id=<?= $employee->ID ?>" class="card card-hover my-3 sec-color" style="border-radius:15px;  box-shadow: unset; height:80px; text-decoration: none;">
