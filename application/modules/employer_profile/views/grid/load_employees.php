...
if (!empty($employees)) {
    foreach ($employees as $index => $employee) { ?>
        ...
        <div class="card card-hover my-3 position-fixed" style="border-radius:15px;  box-shadow: unset; height:80px; ">
            <div class="card-body card-hover border-0" style="border-radius:15px; ">
