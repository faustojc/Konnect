<div class="modal fade" id="<?= $modalId ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="border-radius:15px;">
    <div class="modal-dialog modal-lg modal-dialog-centered " role="document" style="width:;">
        <div class="modal-content border-0" style="border-radius:15px;">
                    ...
                    <div class="row pt-2">
                        <div class="col-md-6">
                            ...
                            <div class="input-group mb-3 ">
                                ...
                                <input id="salary" name="salary" value="<?= $jobpost->salary ?>" type="text" onclick="disableDotZero()" oninput="formatInput2()"
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input id="job_type" name="job_type" class="form-control border-0" style="width:100%; background-color: #F4F6F7; border-radius:10px;" placeholder="e.g. Full-time/Part-time">
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="shift">Schedule</label>
                                <input id="shift" name="shift" class="form-control border-0" style="width:100%; background-color: #F4F6F7; border-radius:10px;" placeholder="e.g. Day/Night/Flextime/8 hour shift">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
            ...
            <div class="modal-footer border-0">
                <button type="button" class="btn text-dark btn-update-job" style="border-radius:10px; width:100%; background-color: #F4F6F7;">Update</button>
            </div>
        </div>
    </div>
</div>